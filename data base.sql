...
INSERT INTO books (book_id,book_name,author_name,book_price)
VALUES
...
INSERT INTO global_discount (discount_id,discount_name,book_id,start_date,end_date,price_after_discount)
VALUES
...
INSERT INTO books_inventory(book_id,amount)
VALUES
(1,8),
(2,19),
(3,20),
...
INSERT INTO suppliers (supp_id,supp_name,phone)
VALUES
...
CREATE TABLE IF NOT EXISTS book_suplliers_prices (
	book_id INT UNSIGNED,
...
INSERT INTO book_suplliers_prices (book_id,supp_id,supplier_price)
VALUES
(1,1,900),
(1,4,800),
(1,3,950),
...
INSERT INTO customers (cust_id,cust_name,phone,join_date)
VALUES
...
CREATE TABLE IF NOT EXISTS customers_10prec_discount (
...
INSERT INTO customers_10prec_discount (cust_id,start_date,end_date)
VALUES
...
INSERT INTO purchases (purch_id,book_id,seller_id,cust_id,purch_date,canceled,full_book_price,total_after_discount)
VALUES
...
INSERT INTO status_of_order (status_id,status_desc)
VALUES
 (1,'order'),
 (2,'In store'),
...
INSERT INTO book_orders (order_id,book_id,supp_id,cust_id,status_id,amount,total_price,order_date)
VALUES
